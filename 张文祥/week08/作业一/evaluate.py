...
def parse_args():
    ...
    parser.add_argument("--model_type", default="biencoder", choices=["biencoder", "crossencoder"],
                        help="模型类型")
    parser.add_argument("--ckpt", default=None, type=str,
                        help="checkpoint .pt 文件路径（默认自动选择）")
...
def main():
    ...
    if args.ckpt is None:
        ...
        if args.model_type == "biencoder":
            ckpt_name = "biencoder_cosine_best.pt"
        args.ckpt = str(CKPT_DIR / ckpt_name)
